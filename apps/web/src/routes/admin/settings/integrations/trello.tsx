    ...
    <div className="space-y-6">
      ...
      {!integration && (
        <IntegrationSetupCard
          ...
          description="Connect Trello to create cards from feedback and sync statuses between Trello lists and Featurepool."
          steps={[
            <p key="1">
            ...
            <p key="2">
              ...
              Featurepool to access your Trello workspace.
            </p>,
