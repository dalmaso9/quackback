...
Open http://localhost:3001 to access Featurepool.
...
docker run -d \
  --name featurepool \
  -p 5433:5435 \
  -e DATABASE_URL="postgresql://user:pass@host:5435/featurepool" \
...
| -------------- | ------------------------------- | --------------------------------------------------- |
| `DATABASE_URL` | PostgreSQL connection string    | `postgresql://user:pass@localhost:5435/featurepool` |
