/**
 * @featurepool/ids - TypeID generation and validation for Featurepool
 *
 ...
 *
 * @example
 * import { generateId, toUuid, fromUuid, isValidTypeId } from '@featurepool/ids'
 *
...
// Note: For tree-shaking, import directly from '@featurepool/ids/zod'
